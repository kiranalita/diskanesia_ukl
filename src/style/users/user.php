                        ...
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="p-2">
                                <?php if (!empty($result['foto_profil'])): ?>
                                    <img src="/ukl/src/style/users/img/<?php echo htmlspecialchars($result['foto_profil']); ?>" 
                                         class="object-center w-32 h-32 rounded-md"
                                         alt="Foto <?php echo htmlspecialchars($result['nama_lengkap']); ?>">
                                <?php else: ?>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex space-x-2">
                                    <a href="kelolauser.php?ubah=<?php echo htmlspecialchars($result['id_user'] ?? ''); ?>" class="px-3 py-1 text-sm text-white bg-green-500 rounded hover:bg-green-600">
                                        <i class="fa fa-pencil"></i> Ubah
                                    </a>
                                    <a href="prosesuser.php?hapus=<?php echo htmlspecialchars($result['id_user'] ?? ''); ?>" class="px-3 py-1 text-sm text-white bg-red-500 rounded hover:bg-red-600" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
